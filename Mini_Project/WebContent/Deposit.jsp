	...
	if(request.getParameter("deposit")!=null){
		...
		try{
		 ...
		 ps=con.prepareStatement(q);
			...
			rs=ps.executeQuery();
		if(rs.next()){
			int d=Integer.parseInt(request.getParameter("deposit"));
...
<input type="text" name="deposit" placeholder="Enter the amount to be deposited" style="width:220px;height:40px;"/><br><br>
<button style="margin-left:60px">DEPOSIT</button>
</form>
</div>
</body>
</html>